...
<script type="module">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <input type="text" required id="list-name" class="w-full border border-gray-300 p-2 rounded-md" placeholder="Nombre de la lista">
                            </div>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
    ...
    <main class="h-full">
        ...
        <div id="Create-comment" class=" mt-24">
        <script type="module">
