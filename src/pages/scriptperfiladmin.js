...
document.getElementById('submitBtncat').addEventListener('click', function() {
    // Obtener el valor del campo de texto
    const newOptionText = document.getElementById('newOptioncreada').value.trim();
    ...
    // Añadir la nueva opción al dropdown
    const dropdown = document.getElementById('dropdowncategorianueva');
    dropdown.appendChild(newOption);

    // Limpiar el campo de texto
    document.getElementById('newOptioncreada').value = '';
});
